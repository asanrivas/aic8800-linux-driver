...
static int aicwf_usb_chipmatch(struct aic_usb_dev *usb_dev, u16_l vid, u16_l pid){
	...
	if(pid == USB_PRODUCT_ID_AIC8801){
        ...
        return 0;
    }else if(pid == USB_PRODUCT_ID_AIC8800D80 || pid == USB_PRODUCT_ID_AIC8800D81 || vid == USB_VENDOR_ID_TP || pid == USB_PRODUCT_ID_AIC8800D83
...
static struct usb_device_id aicwf_usb_id_table[] = {
    ...
    {USB_DEVICE(USB_VENDOR_ID_TENDA, USB_PRODUCT_ID_TENDA_8800D80)},
